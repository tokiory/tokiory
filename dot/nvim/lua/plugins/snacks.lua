return {
  ...
  lazy = false,
  keys = {
    -- { '<leader>o', function() Snacks.picker.smart({ filter = { cwd = true } }) end, desc = 'Find Files' },
    -- { '<leader>m', function() Snacks.picker.diagnostics() end,                      desc = 'Show diagnostics' },
    -- { "<leader>gs", function() Snacks.picker.git_status() end,                       desc = "Git Status" },
    -- { "<leader>p", function() Snacks.picker.recent({ filter = { cwd = true } }) end, desc = "Show recent files" },
